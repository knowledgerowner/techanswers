...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        <div className="text-[35px] font-semibold text-black m-[1%] z-[200] relative">
          Page introuvable
        </div>
        <div className="text-[80px] font-bold text-black m-[1%] z-[200] relative">
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-black m-[1%] z-[200] relative">
          La page que vous cherchez a peut-être été supprimée, a changé de nom, ou est temporairement indisponible.
        </div>
        
        {/* Navigation Buttons */}
        <div className="flex flex-wrap gap-4 mt-8 justify-center z-[200] relative">
          <button
          ...
          <button
            ...
            className="bg-black text-white hover:bg-gray-200 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (currentRef) {
        ...
        currentRef.dispatchEvent(new Event('contentchanged'));
      }
    };
