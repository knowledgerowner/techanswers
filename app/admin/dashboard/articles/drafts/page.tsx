  ...
  const fetchDrafts = async () => {
    try {
      ...
      const params = new URLSearchParams({
        ...
        status: 'draft' // Seulement les brouillons
      });
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.article.isPublished) {
          ...
          // Retirer l'article de la liste des brouillons
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Brouillons</h1>
            <p className="text-gray-600">Gérez vos articles non publiés</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total brouillons</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Brouillons ({filteredArticles.length})</CardTitle>
          <CardDescription>
            Articles en cours de rédaction ou en attente de publication
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Aucun brouillon</h3>
