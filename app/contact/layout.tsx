...
export const metadata: Metadata = {
  ...
  title: "TechAnswers - Contact",
  description: "Contactez-nous pour toute question ou demande de service. Nous sommes à votre écoute pour vous aider.",
  keywords: ["contactez-nous", "a propos de techanswers", "solutions tech", "probleme linux", "probleme windows", "probleme mac", "probleme android", "probleme ios", "probleme web", "probleme mobile", "probleme desktop", "probleme server", "probleme network", "probleme securite", "probleme performance", "probleme maintenance", "probleme support", "probleme formation", "probleme conseil", "probleme audit", "probleme conception", "probleme programmation", "probleme conseil en informatique"],
  ...
  alternates: {
    canonical: "https://www.techanswers.blog/contact",
  },
};
